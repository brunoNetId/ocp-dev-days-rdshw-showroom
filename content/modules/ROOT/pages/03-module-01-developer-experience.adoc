...
. At this point, the code would normally be reviewed and approved by others, but for now, to merge your changes into the main branch, in the *Ready to merge* box click the dropdown on the blue button and click **Merge immediately**.
+
...
. In the *Ready to merge* box click the dropdown on the blue button and click **Merge immediately** to approve the promotion to production.
+
